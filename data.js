...
const curatedCategories = {
  illustration: [
    ...
    },
    {
      name: "水彩風",
      items: [
        item("watercolor-pastel", "柔らかなパステル水彩", "PEw1TUvx1TQ", ["水彩画", "柔らかなパステルカラー", "にじみ", "抽象的な色面", "紙の質感"])
      ]
    },
    {
      name: "切り絵・紙工作風",
  ...
  character: [
    ...
    },
    {
      ...
      items: [
        ...
        item("manga-sketch", "手描きマンガスケッチ", "Y3rduAtYl3c", ["マンガキャラクター", "手描きスケッチ", "紙", "線画", "制作過程"])
      ]
    },
    {
      name: "機械・小物",
  ...
  web: [
    {
      ...
      items: [
        ...
        item("glass-iridescent", "虹色ガラス", "nzkGVjsIkG8", ["ガラス質感", "虹色の反射", "透明な球体", "3D表現", "滑らかなグラデーション"]),
        item("glass-pink-blue", "桃青グラス背景", "gJDvDw889RI", ["グラスモーフィズム", "ピンクと青", "ぼかした背景", "ノイズ質感", "UI背景"])
      ]
    }
  ],
  app: [
  ...
  logo: [
    {
      name: "ブランディング",
      items: [
        item("brand-card-set", "カードモックアップ", "-Tx3hWMD5Aw", ["ブランドモックアップ", "名刺セット", "複数デザイン", "整然とした配置", "企業ブランディング"]),
        item("brand-blue-card", "青文字の名刺", "8bvlWmX4qOs", ["名刺モックアップ", "青いタイポグラフィ", "白い紙", "ミニマル", "クリーンなブランド表現"]),
        item("brand-stationery", "白いステーショナリー", "jmSbZZzRfvU", ["ブランドステーショナリー", "白い名刺", "ノートと封筒", "余白", "統一されたアイデンティティ"]),
        item("brand-identity-wall", "ブランドアイデンティティ", "0n1pmev3w2A", ["ブランドアイデンティティ", "立体文字", "緑の壁", "タイポグラフィ", "コンセプト提示"])
      ]
    }
  ],
  photo: [
    ...
    },
    {
      name: "ポートレート",
      items: [
        item("portrait-bokeh", "自然光とボケ", "clWb0b830Q4", ["ポートレート写真", "自然光", "浅い被写界深度", "柔らかなボケ", "植物の前景"])
      ]
    }
  ],
  product: [
  ...
  fashion: [
    {
      name: "ゴシック",
      items: [
        item("gothic-red-black", "赤と黒の装い", "GBVAz3K9Pdw", ["ゴシックファッション", "赤と黒", "装飾的な衣装", "クラシック", "強いコントラスト"]),
        item("gothic-purple", "紫髪のダークスタイル", "43NJ2zVG3W4", ["ゴシック", "ダークファッション", "紫のアクセント", "ドラマチックな照明", "個性的な表現"]),
        item("gothic-dusk", "夕景のゴシックドレス", "26yd_5n8Kz4", ["ゴシックドレス", "赤と黒", "夕暮れ", "レースの装飾", "シネマティック"])
      ]
    },
    {
      name: "ストリートウェア",
      items: [
        item("streetwear-pair", "二人のストリートスタイル", "-UJtgFSRStU", ["ストリートウェア", "デニム", "カジュアル", "都市の屋外", "現代的な若者文化"]),
        item("streetwear-wall", "黒壁のフーディー", "wQrWkODs59c", ["ストリートウェア", "フーディー", "スニーカー", "サングラス", "黒い背景"]),
        item("streetwear-jacket", "都会的なジャケット", "0wC6FXsLAM0", ["都会的なストリートスタイル", "黒いジャケット", "ミニマルな装い", "黄色いアクセント", "ライフスタイル写真"])
      ]
    }
  ],
  interior: [
    {
      name: "スカンジナビアン",
      items: [
        item("scandi-lamp", "北欧照明とテーブル", "EDij9_MWM_g", ["北欧インテリア", "テーブルランプ", "木製家具", "暖かな光", "居心地のよい空間"])
      ]
    },
    {
      name: "インダストリアル",
      items: [
        ...
        item("industrial-walkway", "鉄骨と大窓の工業空間", "Ssldumx1Nro", ["工業建築", "鉄骨", "大きな窓", "倉庫内部", "金属構造"])
      ]
    },
    {
      name: "ミニマル",
      items: [
        ...
        item("minimal-sideboard", "木製サイドボード", "aX1TTOuq83M", ["ミニマルなリビング", "木製サイドボード", "観葉植物", "白い壁", "自然光"])
      ]
    },
    {
      name: "ジャパンディ",
      items: [
        ...
        item("japandi-slats", "木格子のラウンジ", "Vh-PU2TLZHE", ["日本と北欧の融合", "木格子", "自然素材", "柔らかな自然光", "落ち着いたラウンジ"])
      ]
    },
    {
      name: "ラグジュアリー",
      items: [
        ...
        item("luxury-sectional", "大理石と大型ソファ", "jkwKXLxTY_4", ["ラグジュアリーリビング", "大型ソファ", "大理石の壁", "クリスタル照明", "現代的な高級感"])
      ]
    },
    {
      name: "ボヘミアン",
